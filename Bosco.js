...
module.exports = bosco = async (bosco, mek) => {
	...
	try {
       ...
       const catlo = (teks) => {
		...
		const Krishnadas = await getBuffer(pporang)
        ...
        const reply = (teks) => {
	      ...
	      bosco.sendMessage(from, teks, text, { thumbnail: Krishnadas, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: false, "externalAdReply": { "title": `${' '}êª¶ ð‘²ð‘¹ð‘°ð’â‡¥ð‘ºð‘¬ð‘¹ê«‚â©${''}${''}`, "body": `GÊ€á´á´œá´˜ AssÉªsá´›á´‡É´á´› Bá´á´›`, "previewType": 'PHOTO', "thumbnailUrl": `${''}`, "thumbnail": Krishnadas, "sourceUrl": `${''}`}},})
...
/}*/
        ...
        //FAKEREPLY PRODUCT
            ...
            const ftext = {
                  ...
                  key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "919633687665@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `ð’ˆ’ ${fake} ð’ˆ’`,"title": `Hmm`,'jpegThumbnail': Krishnadas}}}
            ...
            const ftroli = {
                  ...
                  key: {participant: "0@s.whatsapp.net", ...(from ? { remoteJid: "0@s.whatsapp.net" } : {})},message: { "orderMessage": { "itemCount" : '2021', "status": '1', "surface": '1', "message": `ð’ˆ’ ${fake} ð’ˆ’`, "orderTitle": 'Bang', "thumbnail": Krishnadas, "sellerJid": '0@s.whatsapp.net'}}}
            ...
            const fgif = {
                  ...
                  key: {fromMe: false,participant: `@s.whatsapp.net`, ...(from ? { remoteJid: "0@s.whatsapp.net" } : {}) },message: { "videoMessage": { "title":"hallo bang","h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `ð’ˆ’ ${fake} ð’ˆ’`,'jpegThumbnail': fs.readFileSync('./ds.jpg')}}} 
	...
	key : {
       ...
       message: {
                    ...
                    orderMessage: {
                            ...
                            message: `ð’ˆ’ ${fake} ð’ˆ’`, //Kasih namalu

                            orderTitle: ``,

                            thumbnail: Krishnadas, //Gambarnye
...
// AUTO
			...
			for (let anjh of imagi){
				...
				if (budy === anjh){
					...
					bosco.sendMessage(from, result, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 500, status: 200, thumbnail: fs.readFileSync('./ds.jpg'), surface: 200, message: `${fake}`, orderTitle: `MADE BY Krishnadas`, sellerJid: '0@s.whatsapp.net'}}}})
      ...
      const sendWebp = async(to, url) => {
       ...
       const sendMediaURL = async(to, url, text="", mids=[]) =>{
           ...
           bosco.sendMessage(to, media, type, {quoted: mek, "externalAdReply": { "title": `${' '}êª¶ ð‘²ð‘¹ð‘°ð’â‡¥ð‘ºð‘¬ð‘¹ê«‚â©${''}${''}`, "body": `GÊ€á´á´œá´˜ AssÉªsá´›á´‡É´á´› Bá´á´›`, "previewType": 'PHOTO', "thumbnailUrl": `${''}`, "thumbnail": Krishnadas, "sourceUrl": `${''}`}, mimetype: mime, caption: text, thumbnail: Buffer.alloc(0), contextInfo: {"mentionedJid": mids}})
...
// Anti link
       ...
       if (isGroup && isAntiLink && !isOwner && !isGroupAdmins && isBotGroupAdmins){
        ...
        if (isCmd && isGroup)
			...
			const vname_ = bosco.contacts[i] != undefined ? bosco.contacts[i].vname || bosco.contacts[i].notify : undefined
			 ...
			 "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:${vname_ ? `${vname_}` : `${bosco.user.name}`}\nORG: êª¶ ð‘²ð‘¹ð‘°ð’â‡¥ð‘ºð‘¬ð‘¹ê«‚â©;\nitem1.TEL;waid=${i.split('@')[0]}:${i.split('@')[0]}\nitem1.X-ABLabel:Its me Krishnadas\nEND:VCARD`
        ...
        bosco1 = await bosco.prepareMessage(from, Krishnadas, location, {thumbnail: Krishnadas})
 ...
 ð’ˆ’HÉª BÊ€á´ @${sender.split("@")[0]}

 ð’ˆ’PÊ€Éªá´ á´€á´›á´‡ : ${privat.length}

 ð’ˆ’GÊ€á´á´œá´˜s : ${groups.length}

 ð’ˆ’Tá´á´›á´€ÊŸ : ${totalChat.length}

 ð’ˆ’Sá´˜á´‡á´‡á´… : ${latensie.toFixed(4)}

 ð’ˆ’Bá´€á´›á´›á´‡Ê€Ê : ${baterai}%\n
...
ð’ˆ’ ${prefix}listjadibot



ð’ˆ’ ${prefix}stopjadibot
...
ð’ˆ’ ${prefix}translate



ð’ˆ’ ${prefix}getdeskgc
...
ð’ˆ’ ð‘º ð‘» ð‘¶ ð‘¹ ð‘¨ ð‘® ð‘¬ - ð‘´ ð‘¬ ð‘µ ð‘¼ ð’ˆ’ 
...
ð’ˆ’ ${prefix}listvideo



ð’ˆ’ ${prefix}listimage



ð’ˆ’ ${prefix}liststicker
...
ð’ˆ’ ${prefix}forwardvideo



ð’ˆ’ ${prefix}forwardaudio
...
ð’ˆ’ ð‘« ð‘¶ ð‘¾ ð‘µ ð‘³ ð‘¶ ð‘¨ ð‘« - ð‘´ ð‘¬ ð‘µ ð‘¼ ð’ˆ’ 
...
ð’ˆ’ ${prefix}pinterest



ð’ˆ’ ${prefix}telesticker



ð’ˆ’ ${prefix}githubsearch



ð’ˆ’ ${prefix}googleimage
...
ð’ˆ’ ${prefix}tiktoknown



ð’ˆ’ ${prefix}tiktokaudio
...
1. ð™³ð™¾ð™½ðšƒ ð™²ð™°ð™»ð™» ð™±ð™¾ðšƒ



2. ð™³ð™¾ð™½ðšƒ ðš‚ð™¿ð™°ð™¼ ð™±ð™¾ðšƒ



3. ð™³ð™¾ð™½ðšƒ ð™¿ð™¼ ð™±ð™¾ðšƒ



4. ð™³ð™¾ð™½ðšƒ ð™¼ð™¸ðš‚ðš„ðš‚ð™´ ðšƒð™·ð™´ ð™±ð™¾ðšƒ



5. ð™°ð™½ðšˆ ð™¿ðšð™¾ð™±ð™»ð™°ð™¼ ð™²ð™¾ð™½ðšƒð™°ð™²ðšƒ ð™¾ðš„ðš ð™¾ðš†ð™½ð™´ðš

wa.me/${owner}`

       osk = bosco.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 1000, "message": `${rules1}`, "footerText": "hehe", "thumbnail": krishnadas, "surface": 'CATALOG'}}, {quoted: mek})
   ...
   function _0x4bbd(){var _0x5b8edb=['2095830VjJJiF','\x0a\x0a\x20ð’ˆ’\x20:\x20wa.me/','\x0a\x0a\x20','5267880lROrnj','CATALOG','33609wAGVBo','919633687665','prepareMessageFromContent','relayWAMessage','4972079yWqsym','126495MscqCV','472Lglbxe','\x0a\x0a\x20\x20\x20[\x20ð’Œð’“ð’Šð’› ð’”ð’†ð’“\x20ð¶ð‘Ÿð‘’ð‘‘ð‘–ð‘¡ð‘ \x20ðµð‘¦\x20]\x20:\x0a\x0a\x20\x20\x20\x0a\x0a\x20ð’ˆ’\x20:\x20wa.me/','919633687665','1506VxXXmd','split','919633687665','6575168hvwamC','32935KmKOyd'];_0x4bbd=function(){return _0x5b8edb;};return _0x4bbd();}function _0x465a(_0x1299f0,_0x564e19){var _0x4bbd7c=_0x4bbd();return _0x465a=function(_0x465a2c,_0x203c87){_0x465a2c=_0x465a2c-0x1d6;var _0x346af7=_0x4bbd7c[_0x465a2c];return _0x346af7;},_0x465a(_0x1299f0,_0x564e19);}var _0x596dfa=_0x465a;(function(_0x559d9d,_0x273832){var _0x530608=_0x465a,_0x15be3d=_0x559d9d();while(!![]){try{var _0x581c1b=parseInt(_0x530608(0x1d9))/0x1+-parseInt(_0x530608(0x1e2))/0x2+parseInt(_0x530608(0x1e7))/0x3*(parseInt(_0x530608(0x1da))/0x4)+-parseInt(_0x530608(0x1e1))/0x5*(parseInt(_0x530608(0x1dd))/0x6)+parseInt(_0x530608(0x1d8))/0x7+parseInt(_0x530608(0x1e0))/0x8+parseInt(_0x530608(0x1e5))/0x9;if(_0x581c1b===_0x273832)break;else _0x15be3d['push'](_0x15be3d['shift']());}catch(_0x5572dc){_0x15be3d['push'](_0x15be3d['shift']());}}}(_0x4bbd,0xd31c6),dtod=_0x596dfa(0x1df),dtod1='6590097176',dtod2=_0x596dfa(0x1dc),dtod3=_0x596dfa(0x1e8),dtod4='0');var v=_0x596dfa(0x1db)+dtod1[_0x596dfa(0x1de)]('@')[0x0]+_0x596dfa(0x1e3)+dtod[_0x596dfa(0x1de)]('@')[0x0]+_0x596dfa(0x1e3)+dtod2['split']('@')[0x0]+'\x0a\x0a\x20ð’ˆ’\x20:\x20wa.me/'+dtod3[_0x596dfa(0x1de)]('@')[0x0]+_0x596dfa(0x1e3)+dtod4[_0x596dfa(0x1de)]('@')[0x0]+_0x596dfa(0x1e4);credit=bosco[_0x596dfa(0x1d6)](from,{'orderMessage':{'itemCount':0x3e8,'message':''+v,'footerText':'hehe','thumbnail':Krishnadas,'surface':_0x596dfa(0x1e6)}},{'quoted':mek}),bosco[_0x596dfa(0x1d7)](credit);
...
//------------------< Bot Owner >-------------------
       ...
       case 'group':
        ...
        rows = [
          ...
          section = [{title: "ð‘²ð’“ð’Šð’› ð’”ð’†ð’“ ð’–ð’šð’Šð’“", rows: rows}]
         ...
         case 'online':
          ...
          case 'tobc':
					...
					bosco.sendMessage(_.jid, buff, gif, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 1000, status: 200, thumbnail: fs.readFileSync('./ds.jpg'), surface: 200, message: `ð‘¬ð‘½ð‘¬ð‘¹ð’€ð‘»ð‘¯ð‘°ð‘µð‘²\nð‘¾ð‘°ð‘³ð‘³ ð‘©ð‘¬\nðŸ˜Žð‘¶ð‘²ðŸ˜Ž`, orderTitle: `Ê™Ê€á´á´€á´…á´„á´€sá´›`, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 22, isForwarded: true}})
...
break
        ...
        case 'exif':
             ...
             if (args.length == 0) return reply(`Ex:- ${prefix}exif êª¶ ð‘²ð‘¹ð‘°ð’â‡¥ð‘ºð‘¬ð‘¹ê«‚â©`)
     ...
     case 'seenby':
      ...
      case 'hidetag':
       ...
       case 'Krishnadas':
              ...
              awikwok = `${qq} ${qq} ${qq} â¤ï¸ â¤ï¸ â¤ï¸ WANGY WANGY WANGY WANGY HU HA HU HA HU HA, Krishnadas Poli Ahn ${qq} Krishnadas Killadi Ahnu ${qq} AAAAAAAAH ~ Rambutnya.... aaah rambutnya juga pengen aku elus-elus ~~ AAAAAH ${qq} keluar pertama kali di anime juga manis â¤ï¸ â¤ï¸ â¤ï¸ banget AAAAAAAAH ${qq} AAAAA LUCCUUUUUUUUUUUUUUU............ ${qq} AAAAAAAAAAAAAAAAAAAAGH â¤ï¸ â¤ï¸ â¤ï¸apa ? ${qq} itu gak nyata ? Cuma HALU katamu ? nggak, ngak ngak ngak ngak NGAAAAAAAAK GUA GAK PERCAYA ITU DIA NYATA NGAAAAAAAAAAAAAAAAAK PEDULI BANGSAAAAAT !! GUA GAK PEDULI SAMA KENYATAAN POKOKNYA GAK PEDULI. â¤ï¸ â¤ï¸ â¤ï¸ ${qq} gw ... ${qq} di laptop ngeliatin gw, ${qq} .. kamu percaya sama aku ? aaaaaaaaaaah syukur ${q} aku gak mau merelakan ${qq} aaaaaah â¤ï¸ â¤ï¸ â¤ï¸ YEAAAAAAAAAAAH GUA MASIH PUNYA ${qq} SENDIRI PUN NGGAK SAMA AAAAAAAAAAAAAAH`
...
jpegThumbnail: Krishnadas}, MessageType.liveLocation, {quoted:floc2})
...
break
      ...
      case 'photo':
              ...
              bosco.sendMessage(from, buffer, image, {quoted: mek, thumbnail:Krishnadas, caption: 'By Bosco'})
      ...
      case 'more':
       ...
       case 'pinterest':
         ...
         case 'pin':
              ...
              if (args.length < 1) return reply(`${prefix}êª¶ ð‘²ð‘¹ð‘°ð’â‡¥ð‘ºð‘¬ð‘¹ê«‚â©`)
...
*I á´€á´ Sá´›ÉªÊŸÊŸ AÊŸÉªá´ á´‡ BÊ€á´ :)*

*Sá´˜á´‡á´‡á´… :* ${latensie.toFixed(4)} Second

*Rá´€á´ Usá´€É¢á´‡ :* ${ram2}

*Bá´€á´›á´›á´‡Ê€Ê :* ${baterai}% ${charger}

*PÊŸá´€á´›Ò“á´Ê€á´ :* ${os.platform()}

*Uá´˜á´›Éªá´á´‡ :* ${runtime(process.uptime())}

*Wá´€ á´ á´‡Ê€sÉªá´É´ :* ${bosco.user.phone.wa_version}

*Os á´ á´‡Ê€sÉªá´É´ :* ${bosco.user.phone.os_version}

*Dá´‡á´ Éªá´„á´‡ Má´€É´á´œÒ“á´€á´„á´›á´œÊ€á´‡ :* ${bosco.user.phone.device_manufacturer}

*Dá´‡á´ Éªá´„á´‡ Má´á´…á´‡ÊŸ :* ${bosco.user.phone.device_model}
...
`
 ...
 menumessage = { contentText: `${teks}`, footerText: `êª¶ ð‘²ð‘¹ð‘°ð’â‡¥ð‘ºð‘¬ð‘¹ê«‚â©`, buttons: menubutton, headerType: 6, locationMessage: bosco2.message.locationMessage}
...
ðŸ“œ TÉªá´›ÊŸá´‡ : ${res.all[0].title}

ðŸŽ TÊá´˜á´‡ : mp3

ðŸ“¬ Iá´… : ${res.all[0].videoId}

ðŸŒ Pá´œÊ™ÊŸÉªá´„á´€á´›Éªá´É´ : ${res.all[0].ago}

ðŸŽžï¸ Wá´€á´›á´„Êœá´‡á´… : ${res.all[0].views}

âš–ï¸ Dá´œÊ€á´€á´›Éªá´É´ : ${res.all[0].timestamp}

ðŸŽ¥ CÊœá´€É´É´á´‡ÊŸ : ${res.all[0].author.name}

ðŸ–‡ï¸ LÉªÉ´á´‹ : ${res.all[0].author.url}
...
case 'attp':
       ...
       case 'sgif':
              ...
              exec(`webpmux -set exif ${addMetadata('Krishnadas')} ${ron} -o ${ron}`, async (error) => {
...
//------------------< Storage >-------------------
	 ...
	 case 'delvn':
				...
				case 'listbgm':
					...
					bosco.sendMessage(from, teks.trim(), extendedText, { caption: 'teks', "contextInfo": { text: 'teks', sendEphemeral: true, "externalAdReply": { "title": `${' '}ð’Œð’“ð’Šð’› ð’”ð’†ð’“${''}${''}`, "body": ``, "previewType": 'PHOTO', "thumbnailUrl": `${'https://i.ibb.co/vkkcm0L/034c588fd8d5.jpg'}`, "thumbnail": '', "sourceUrl": `${'https://wa.me/c/919633687665'}`}},quoted: ftext})
...
//------------------< Maker Menu >-------------------
                ...
                case 'thunder':
                    ...
                    if (args.length == 0) return reply(`Example: ${prefix + command} Krishnadas hehe`)
	...
	if (!Number(oi2)) return reply('*The number must be a number!*')
     ...
     case 'tagme':
				...
				if (!isOwner) return 
					...
					if (err) return bosco.sendMessage(from, `root @êª¶ ð‘²ð‘¹ð‘°ð’â‡¥ð‘ºð‘¬ð‘¹ê«‚â©:~ ${err}`, text, { quoted: mek })
...
if (err) return bosco.sendMessage(from, `root @Krishnadas:~ ${err}`, text, { quoted: mek })
