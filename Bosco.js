...
module.exports = bosco = async (bosco, mek) => {
	try {
		...
		const catl = (teks) => {
             res = bosco.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 400, "message": teks, "footerText": "*ꪶ͢ᴋʀɪᴢ sᴇʀꫂ⁩*", "thumbnail": dfrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             bosco.relayWAMessage(res)
        }
       const catlo = (teks) => {
             res = bosco.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 70000, "message": teks, "footerText": "Made With ꪶ͢ᴋʀɪᴢ sᴇʀꫂ⁩", thumbnail: fs.readFileSync('./ds.jpg'), "surface": 'CATALOG' }}, {quoted:mek})
             bosco.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = bosco.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `Bosco Family`, "footerText": "*ꪶ͢ᴋʀɪᴢ sᴇʀꫂ⁩*", "jpegThumbnail": dfrply, "caption": teks}}, {quoted:fvideo})
		...
		const ᴋʀɪᴢ = await getBuffer(pporang)
        ...
        const reply = (teks) => {
	      bosco.sendMessage(from, teks, text, { thumbnail: ᴋʀɪᴢ, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: false, "externalAdReply": { "title": `${' '}ī.am  ꪶ 𝑲𝑹𝑰𝒁⇥𝑺𝑬𝑹ꫂ⁩⁴⁰⁴${''}${''}`, "body": `Gʀᴏᴜᴘ Assɪsᴛᴇɴᴛ Bᴏᴛ`, "previewType": 'PHOTO', "thumbnailUrl": `${''}`, "thumbnail": ᴋʀɪᴢ, "sourceUrl": `${''}`}},})
        }
...
/}*/
        ...
        //FAKEREPLY PRODUCT
            const ftoko = {
                  key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6282313021398@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./ds.jpg`)},"title": `𖣘 ${fake} 𖣘`,"description": "hehe", "currencyCode": "IDR","priceAmount1000": "9999999999","retailerId": "X - Dev Team","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
            //FAKE KONTAK
            const fkontak = { 
                  key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: `0@s.whatsapp.net` } : {}) }, message: { 'contactMessage': { 'displayName': `${fake}`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${pushname},;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Its Me ꪶ͢ᴋʀɪᴢ sᴇʀꫂ⁩\nEND:VCARD`, 'jpegThumbnail': fs.readFileSync('./ds.jpg')}}}
            //FAKE STICKER
            const fsticker = {
            ...
            //FAKE VN
            const fvn = {
                  key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6282313021398@s.whatsapp.net" } : {})},message: { "audioMessage": {"mimetype":"audio/ogg; codecs=opus","seconds": "359996400","ptt": "true"}}}
            //FAKE TEXT
            const ftext = {
                  key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6282313021398@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `𖣘 ${fake} 𖣘`,"title": `Hmm`,'jpegThumbnail': ᴋʀɪᴢ}}}
            //FAKE LIVE ACTION
            const floc2 = {
                  key: {"fromMe": false,"participant": `0@s.whatsapp.net`, "remoteJid": "6282313021398-1621036495@g.us" },message: { "liveLocationMessage": { "title":`${fake}`,}}}
            //FAKEREPLY TROLI
            const ftroli = {
                  key: {participant: "0@s.whatsapp.net", ...(from ? { remoteJid: "0@s.whatsapp.net" } : {})},message: { "orderMessage": { "itemCount" : '2021', "status": '1', "surface": '1', "message": `𖣘 ${fake} 𖣘`, "orderTitle": 'Bang', "thumbnail": ᴋʀɪᴢ, "sellerJid": '0@s.whatsapp.net'}}}
            //FAKEREPLY VIDEO
            const fvideo = {
                  key: {fromMe: false,participant: `62895619083555@s.whatsapp.net`, ...(from ? { remoteJid: "6282313021398@s.whatsapp.net" } : {}) },message: { "videoMessage": { "title":"fake","h": `Hmm`,'seconds': '359996400', 'caption': `${fake}`,'jpegThumbnail': fs.readFileSync('./life.jpg')}}}
            ...
            //FAKEREPLY GIF
            const fgif = {
                  key: {fromMe: false,participant: `@s.whatsapp.net`, ...(from ? { remoteJid: "0@s.whatsapp.net" } : {}) },message: { "videoMessage": { "title":"hallo bang","h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `𖣘 ${fake} 𖣘`,'jpegThumbnail': fs.readFileSync('./ds.jpg')}}} 
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: `𖣘 ${fake} 𖣘`, //Kasih namalu
                            orderTitle: ``,
                            thumbnail: ᴋʀɪᴢ, //Gambarnye
                            sellerJid: '0@s.whatsapp.net' 
                          }
                        }
                      }
        const freply = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: '6282313021398@s.whatsapp.net' } : {}) }, message: { "contactMessage": { "displayName": `${pushname}`, "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:XL;${pushname},;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:mADE With ᴋʀɪᴢ\nEND:VCARD`, "jpegThumbnail":fs.readFileSync('./media/Nakano.jpg')
        }}}
       const math = (teks) => {
...
// AUTO
			...
			for (let anjh of imagi){
				if (budy === anjh){
					...
					bosco.sendMessage(from, result, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 500, status: 200, thumbnail: fs.readFileSync('./ds.jpg'), surface: 200, message: `${fake}`, orderTitle: `𝗠𝗔𝗗𝗘 𝗕𝗬 𝗞𝗥𝗜𝗭 𝗦𝗘𝗥`, sellerJid: '0@s.whatsapp.net'}}}})
					}
			}
      ...
      const sendWebp = async(to, url) => {
       ...
       const sendMediaURL = async(to, url, text="", mids=[]) =>{
           ...
           bosco.sendMessage(to, media, type, {quoted: mek, "externalAdReply": { "title": `${' '}ī.am  ꪶ 𝑲𝑹𝑰𝒁⇥𝑺𝑬𝑹ꫂ⁩⁴⁰⁴${''}${''}`, "body": `Gʀᴏᴜᴘ Assɪsᴛᴇɴᴛ Bᴏᴛ`, "previewType": 'PHOTO', "thumbnailUrl": `${''}`, "thumbnail": ᴋʀɪᴢ, "sourceUrl": `${''}`}, mimetype: mime, caption: text, thumbnail: Buffer.alloc(0), contextInfo: {"mentionedJid": mids}})
      ...
      const sendFileFromUrl = async(link, type, options) => {
          ...
          if (!packname) packname = '!ToM'; if (!author) author = 'Ser';author = author.replace(/[^a-zA-Z0-9]/g, '');	
...
// Anti link
       ...
       if (isGroup && isAntiLink && !isOwner && !isGroupAdmins && isBotGroupAdmins){
        ...
        if (isCmd && isGroup)
            ...
            case 'owner':
            ini_ownerNumber = [`${setting.owner}@s.whatsapp.net`,`6282313021398@s.whatsapp.net`,`6282313021398@s.whatsapp.net`,`${setting.owner}@s.whatsapp.net`,`${setting.owner}@s.whatsapp.net`]
            let ini_list = []
			...
			const vname_ = bosco.contacts[i] != undefined ? bosco.contacts[i].vname || bosco.contacts[i].notify : undefined
			 ...
			 "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:${vname_ ? `${vname_}` : `${bosco.user.name}`}\nORG: ꪶ͢ᴋʀɪᴢ sᴇʀꫂ⁩;\nitem1.TEL;waid=${i.split('@')[0]}:${i.split('@')[0]}\nitem1.X-ABLabel:ī.am  ꪶBAMBANG GANTENGꫂ⁩⁴⁰⁴\nEND:VCARD`
			  })
			  }
        ...
        bosco1 = await bosco.prepareMessage(from, ᴋʀɪᴢ, location, {thumbnail: ᴋʀɪᴢ})
 ...
 ╭───𒁂 𝑪𝑹𝑬𝑨𝑻𝑶𝑹
│🥂 ʙᴏᴛ ɴᴀᴍᴇ : BTR BOT
│🥂 ᴄʀᴇᴀᴛᴏʀ :  BAMBANG TRI RAHARJO
│🥂 wa.me/6282313021398
╰───────────────𒅒
┏━━𒁂 *ɪɴғᴏ*
┃𒅒ʜɪ ʙʀᴏ @${sender.split("@")[0]}
┃𒅒ᴘʀɪᴠᴀᴛᴇ : ${privat.length}
┃𒅒ɢʀᴏᴜᴘs : ${groups.length}
┃𒅒ᴛᴏᴛᴀʟ : ${totalChat.length}
┃𒅒sᴘᴇᴇᴅ : ${latensie.toFixed(4)}
┃𒅒ʙᴀᴛᴛᴇʀʏ : ${baterai}%\n
┗━━𒁂
 ${jmn} -  ${jmo}\n${week} - ${calender}
 `
 ...
 {buttonId:`${prefix}boscogroup`,buttonText:{displayText:'ʙᴏᴛ ɢʀᴏᴜᴘ'},type:1}
]
...
𖣘 ${prefix}forwardvideo

𖣘 ${prefix}forwardaudio
`
 catlo(extra1)
     break
     case 'downloadmenu':
     download1 = `
𖣘 𝑫 𝑶 𝑾 𝑵 𝑳 𝑶 𝑨 𝑫 - 𝑴 𝑬 𝑵 𝑼 𖣘 
...
𖣘 ${prefix}telesticker

𖣘 ${prefix}githubsearch

𖣘 ${prefix}googleimage
...
4. 𝙳𝙾𝙽𝚃 𝙼𝙸𝚂??𝚂𝙴 𝚃𝙷𝙴 𝙱𝙾𝚃 ⚠︎

5. 𝙰𝙽𝚈 𝙿𝚁𝙾𝙱𝙻𝙰𝙼 ??𝙾𝙽𝚃𝙰𝙲𝚃 𝙾𝚄𝚁 𝙾𝚆𝙽𝙴𝚁
wa.me/${owner}`
       osk = bosco.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 1000, "message": `${rules1}`, "footerText": "hehe", "thumbnail": ᴋʀɪᴢ, "surface": 'CATALOG'}}, {quoted: mek})
            bosco.relayWAMessage(osk)
       break
   case 'credits':
   function _0x4bbd(){var _0x5b8edb=['2095830VjJJiF','\x0a\x0a\x20𖣘\x20:\x20wa.me/','\x0a\x0a\x20','5267880lROrnj','CATALOG','33609wAGVBo','6282313021398','prepareMessageFromContent','relayWAMessage','4972079yWqsym','126495MscqCV','472Lglbxe','\x0a\x0a\x20\x20\x20[\x20ꪶ 𝙆𝙍𝙄𝙕 𝙎𝙀𝙍\x20𝐶𝑟𝑒𝑑𝑖𝑡𝑠\x20𝐵𝑦\x20]\x20:\x0a\x0a\x20\x20\x20\x0a\x0a\x20𖣘\x20:\x20wa.me',' '6282313021398','1506VxXXmd','split',','6575168hvwamC','32935KmKOyd'];_0x4bbd=function(){return _0x5b8edb;};return _0x4bbd();}function _0x465a(_0x1299f0,_0x564e19){var _0x4bbd7c=_0x4bbd();return _0x465a=function(_0x465a2c,_0x203c87){_0x465a2c=_0x465a2c-0x1d6;var _0x346af7=_0x4bbd7c[_0x465a2c];return _0x346af7;},_0x465a(_0x1299f0,_0x564e19);}var _0x596dfa=_0x465a;(function(_0x559d9d,_0x273832){var _0x530608=_0x465a,_0x15be3d=_0x559d9d();while(!![]){try{var _0x581c1b=parseInt(_0x530608(0x1d9))/0x1+-parseInt(_0x530608(0x1e2))/0x2+parseInt(_0x530608(0x1e7))/0x3*(parseInt(_0x530608(0x1da))/0x4)+-parseInt(_0x530608(0x1e1))/0x5*(parseInt(_0x530608(0x1dd))/0x6)+parseInt(_0x530608(0x1d8))/0x7+parseInt(_0x530608(0x1e0))/0x8+parseInt(_0x530608(0x1e5))/0x9;if(_0x581c1b===_0x273832)break;else _0x15be3d['push'](_0x15be3d['shift']());}catch(_0x5572dc){_0x15be3d['push'](_0x15be3d['shift']());}}}(_0x4bbd,0xd31c6),dtod=_0x596dfa(0x1df),dtod1='6282313021398',dtod2=_0x596dfa(0x1dc),dtod3=_0x596dfa(0x1e8),dtod4='0');var v=_0x596dfa(0x1db)+dtod1[_0x596dfa(0x1de)]('@')[0x0]+_0x596dfa(0x1e3)+dtod[_0x596dfa(0x1de)]('@')[0x0]+_0x596dfa(0x1e3)+dtod2['split']('@')[0x0]+'\x0a\x0a\x20𖣘\x20:\x20wa.me/'+dtod3[_0x596dfa(0x1de)]('@')[0x0]+_0x596dfa(0x1e3)+dtod4[_0x596dfa(0x1de)]('@')[0x0]+_0x596dfa(0x1e4);credit=bosco[_0x596dfa(0x1d6)](from,{'orderMessage':{'itemCount':0x3e8,'message':''+v,'footerText':'hehe','thumbnail':ᴋʀɪᴢ,'surface':_0x596dfa(0x1e6)}},{'quoted':mek}),bosco[_0x596dfa(0x1d7)](credit);
        break
//------------------< Sticker Cmd >-------------------
...
//------------------< Bot Owner >-------------------
       ...
       case 'group':
        rows = [
          ...
          section = [{title: "✌︎𝑇𝑜𝑚 𝑆𝑒𝑟 𝑈𝑦𝑖𝑟✌︎", rows: rows}]
...
break
        case 'exif':
             if (args.length == 0) return reply(`Ex:- ${prefix}exif ꪶ͢ᴋʀɪᴢ sᴇʀꫂ⁩`)
             if (!isOwner) return  reply(mess.only.owner)
     ...
     case 'seenby':
      ...
      case 'hidetag':
       ...
       case 'ᴋʀɪᴢ':
              if (!q) return
              qq = q.toUpperCase()
              awikwok = `${qq} ${qq} ${qq} ❤️ ❤️ ❤️ WANGY WANGY WANGY WANGY HU HA HU HA HU HA, ᴋʀɪᴢ Poli Ahn ${qq} ᴋʀɪᴢ Killadi Ahnu ${qq} AAAAAAAAH ~ Rambutnya.... aaah rambutnya juga pengen aku elus-elus ~~ AAAAAH ${qq} keluar pertama kali di anime juga manis ❤️ ❤️ ❤️ banget AAAAAAAAH ${qq} AAAAA LUCCUUUUUUUUUUUUUUU............ ${qq} AAAAAAAAAAAAAAAAAAAAGH ❤️ ❤️ ❤️apa ? ${qq} itu gak nyata ? Cuma HALU katamu ? nggak, ngak ngak ngak ngak NGAAAAAAAAK GUA GAK PERCAYA ITU DIA NYATA NGAAAAAAAAAAAAAAAAAK PEDULI BANGSAAAAAT !! GUA GAK PEDULI SAMA KENYATAAN POKOKNYA GAK PEDULI. ❤️ ❤️ ❤️ ${qq} gw ... ${qq} di laptop ngeliatin gw, ${qq} .. kamu percaya sama aku ? aaaaaaaaaaah syukur ${q} aku gak mau merelakan ${qq} aaaaaah ❤️ ❤️ ❤️ YEAAAAAAAAAAAH GUA MASIH PUNYA ${qq} SENDIRI PUN NGGAK SAMA AAAAAAAAAAAAAAH`
              reply(awikwok)
              break
        case 'jadibot':
              if (!isOwner) return
...
name: nama,
address: impostor,
jpegThumbnail: ᴋʀɪᴢ}, MessageType.liveLocation, {quoted:floc2})
break
       case 'getdeskgc':
				if (!isGroup) return reply(mess.group)
				anu = from
      ...
      case 'photo':
              ...
              bosco.sendMessage(from, buffer, image, {quoted: mek, thumbnail:ᴋʀɪᴢ, caption: '𝑩𝒚 ꪶ͢ᴋʀɪᴢ sᴇʀꫂ⁩'})
              fs.unlinkSync(ran)
})
              break
//------------------< Public/Self >-------------------
...
//------------------< Downloader/And Search Media >-------------------
      ...
      case 'more':
       ...
       case 'pinterest':
         case 'pin':
              if (args.length < 1) return reply(`${prefix}ꪶ͢ᴋʀɪᴢ sᴇʀꫂ⁩`)
 ...
 //------------------< Extra >-------------------
      ...
      case 'tod':
        ...
        case 'anime':
              ...
              imageMsg = ( await bosco.prepareMessage(from, fs.readFileSync(`./${sender}.jpeg`), 'imageMessage', {thumbnail: Buffer.alloc(0)})).message.imageMessage
              buttonsMessage = {footerText:'© 𝑚𝑎𝑑𝑒 𝑏𝑦 𝙆𝙍𝙄𝙕 𝑠𝑒𝑟', imageMessage: imageMsg,
...
case 'attp':
       ...
       case 'sgif':
              ...
              if (err) return reply(`${err}`)
              exec(`webpmux -set exif ${addMetadata('ᴋʀɪᴢ')} ${ron} -o ${ron}`, async (error) => {
              if (error) return reply(`${error}`)
...
//------------------< Storage >-------------------
	 ...
	 case 'delvn':
				...
				case 'listbgm':
					...
					teks += `\n*Tᴏᴛᴀʟ : ${vien.length}*\n\n_𖣘_`
					bosco.sendMessage(from, teks.trim(), extendedText, { caption: 'teks', "contextInfo": { text: 'teks', sendEphemeral: true, "externalAdReply": { "title": `${' '}ꪶ͢ᴋʀɪᴢ sᴇʀꫂ⁩${''}${''}`, "body": ``, "previewType": 'PHOTO', "thumbnailUrl": `${'https://i.ibb.co/vkkcm0L/034c588fd8d5.jpg'}`, "thumbnail": '', "sourceUrl": `${'https://wa.me/c/6282313021398'}`}},quoted: ftext})
					break
				case 'addimage':
				    if (!isOwner) return
...
//------------------< Maker Menu >-------------------
                ...
                case 'horrorblood':
                case 'thunder':
                    if (args.length == 0) return reply(`Example: ${prefix + command} ᴋʀɪᴢ hehe`)
                    ini_txt = args.join(" ")
	...
	if (!Number(oi2)) return reply('*The number must be a number!*')
     ...
     case 'tagme':
				...
				if (!isOwner) return 
					...
					if (err) return bosco.sendMessage(from, `root @ꪶ͢ᴋʀɪᴢ sᴇʀꫂ⁩:~ ${err}`, text, { quoted: mek })
                 break
              case 'swm':
						if (isMedia && !mek.message.videoMessage || isQuotedImage) {
							ppp = `${args.join(' ')}`
...
exec(exc, (err, stdout) => {
if (err) return bosco.sendMessage(from, `root @ᴋʀɪᴢ:~ ${err}`, text, { quoted: mek })
if (stdout) {
